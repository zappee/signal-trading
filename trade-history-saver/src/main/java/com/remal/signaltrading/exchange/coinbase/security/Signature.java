...
public class Signature {
     ...
     * @param timestamp timestamp of your request
    ...
    public String generate(String requestPath, String method, String body, String timestamp) {
        try {
            ...
            SecretKeySpec keyspec = new SecretKeySpec(secretDecoded, ExchangeConstants.mac.getAlgorithm());
            Mac sha256 = (Mac) ExchangeConstants.mac.clone();
            sha256.init(keyspec);
